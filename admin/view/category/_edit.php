                        ...
                        <div class="card-body">
                            <form action="edit.php"  method = "POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="<?php echo $category['name']; ?>" class="form-control" id="name" aria-describedby="emailHelp" placeholder="">
                                </div>
                               
                                <div class="form-group">
                                    <label for="description">Description</label>
                                    <input type="text" name="description" value="<?php echo $category['description']; ?>"  class="form-control" id="description" placeholder="">
                                </div>
